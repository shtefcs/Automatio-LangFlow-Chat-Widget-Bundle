(() => {
  // First, let's add a simple markdown parser function
  ...
  class ChatClient {
    ...
    async sendMessage(message) {
      ...
      try {
        console.log('[ChatClient] Making request to:', `${this.hostUrl}/api/v1/run/${this.flowId}`);
  ...
  class LangFlowChat extends HTMLElement {
    ...
    showTypingIndicator() {
      ...
      typingContainer.innerHTML = `
        <div class="avatar">
          <img src="https://api.dicebear.com/7.x/bottts/svg?seed=Kara" alt="Kara Avatar">
        </div>
    ...
    addMessage(role, content) {
      ...
      if (role === 'assistant') {
        avatar.innerHTML = `<img src="https://api.dicebear.com/7.x/bottts/svg?seed=Kara" alt="Kara Avatar">`;
      } else {
        avatar.innerHTML = `<img src="https://api.dicebear.com/7.x/avataaars/svg?seed=user" alt="User Avatar">`;
      }
      
      // Add message with rendered markdown
